    ...
    fields: [
      {
        ...
        options: [
          ...
          { label: 'GLM-5.2-jcloud — 智谱 GLM 5.2（jcloud）', value: 'GLM-5.2-jcloud' },
          { label: 'Kimi-K3 — Moonshot Kimi K3', value: 'Kimi-K3' },
          { label: 'Kimi-K3-jcloud — Moonshot Kimi K3（jcloud）', value: 'Kimi-K3-jcloud' },
          { label: 'DeepSeek-V4-Pro — DeepSeek V4 Pro', value: 'DeepSeek-V4-Pro' },
          { label: 'MiniMax-M3 — MiniMax M3', value: 'MiniMax-M3' },
